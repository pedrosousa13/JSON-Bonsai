...
- JMESPath query bar (`Q`) — filter and reshape the JSON; the result renders as a fully interactive tree, and drives every other view (table, formatted, raw, schema) and Copy until the query is cleared
